...
| Gói thuê bao | Giá/quyền lợi snapshot, settlement idempotent, mandate VNPAY, renewal cycle/attempt, primary/fallback, QueryDr, retry/grace, price consent và audit bất biến | Độc giả mua gói, chọn auto-renew/nguồn tiền, đổi thiết lập, chấp nhận giá hoặc hủy cuối kỳ; admin có queue renewal | Migration `20260804`–`20260809`, test checkout/renewal/concurrency và `doc/production-readiness-acceptance.md` | Backend/UI/MySQL local đạt; còn provider production |
