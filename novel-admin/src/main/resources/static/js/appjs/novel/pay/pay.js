        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'outTradeNo',
                        title: adminMessage('paymentTradeNo', 'Mã đơn hàng')
                    },
...

                    {
                        ...
                        formatter: function (value, row, index) {
                            return value === 0 ? adminMessage('paymentFailed', 'Nạp thất bại') : value === 1 ? adminMessage('paymentSuccess', 'Nạp thành công') : value === 2 ? adminMessage('paymentPending', 'Chờ thanh toán') : adminMessage('other', 'Khác');
                        }
                    },
