...
function validateRule() {
    ...
    messages: {
                                                        inviteCode: {
                required: icon + adminMessage('authorCodeInviteRequired', 'Vui lòng nhập mã mời')
            },                                                 validityTime: {
                required: icon + adminMessage('authorCodeValidUntilRequired', 'Vui lòng nhập thời hạn hiệu lực')
            },                                                                                     }
})
}
