        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'bookName',
                        title: adminMessage('bookCommentBook', 'Truyện được bình luận')
                    },

                    {
                        field: 'commentContent',
                        title: adminMessage('bookCommentContent', 'Nội dung bình luận')
                    },


                    {
                        field: 'createTime',
                        title: adminMessage('bookCommentTime', 'Thời gian bình luận')
                    },


                    {
                        field: 'userName',
                        title: adminMessage('bookCommentUser', 'Người bình luận')
                    },
