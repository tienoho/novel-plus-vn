        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'userName',
                        title: adminMessage('feedbackUser', 'Người gửi phản hồi')
                    },


                    {
                        field: 'content',
                        title: adminMessage('feedbackContent', 'Nội dung phản hồi')
                    },


                    {
                        field: 'createTime',
                        title: adminMessage('feedbackTime', 'Thời gian phản hồi')
                    }
