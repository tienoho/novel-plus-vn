        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'catName',
                        title: adminMessage('newsCategoryName', 'Tên danh mục')
                    },


                    {
                        field: 'sourceName',
                        title: adminMessage('newsSource', 'Nguồn')
                    },


                    {
                        field: 'title',
                        title: adminMessage('newsTitle', 'Tiêu đề')
                    },
                    ...
                    {
                        field: 'createTime',
                        title: adminMessage('newsPublishedAt', 'Thời gian xuất bản')
                    },
