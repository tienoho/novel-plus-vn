        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'linkName',
                        title: adminMessage('friendLinkName', 'Tên liên kết')
                    },


                    {
                        field: 'linkUrl',
                        title: adminMessage('friendLinkUrl', 'URL liên kết')
                    },


                    {
                        field: 'sort',
                        title: adminMessage('friendLinkSort', 'Thứ tự')
                    },


                    {
                        field: 'isOpen',
                        title: adminMessage('friendLinkEnabled', 'Đang bật'),
