...
function validateRule() {
    ...
    messages: {
                                                        bookId: {
                required: icon + adminMessage('bookSettingBookIdRequired', 'Vui lòng nhập ID truyện')
            },                                                 sort: {
                required: icon + adminMessage('bookSettingSortRequired', 'Vui lòng nhập thứ tự')
            },                                                 type: {
                required: icon + adminMessage('bookSettingTypeRequired', 'Vui lòng chọn loại đề xuất')
            },                                                                                                         }
})
}
