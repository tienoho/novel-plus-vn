        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'inviteCode',
                        title: adminMessage('authorInviteCode', 'Mã mời')
                    },


                    {
                        field: 'penName',
                        title: adminMessage('authorPenName', 'Bút danh')
                    },


                    {
                        field: 'telPhone',
                        title: adminMessage('authorPhone', 'Số điện thoại')
                    },


                    {
                        field: 'chatAccount',
                        title: adminMessage('authorSocial', 'Tài khoản QQ hoặc WeChat')
                    },


                    {
                        field: 'email',
                        title: adminMessage('authorEmail', 'Email')
                    },


                    {
                        field: 'workDirection',
                        title: adminMessage('authorDirection', 'Kênh sáng tác'),
                    ...
                    {
                        field: 'createTime',
                        title: adminMessage('authorJoinedAt', 'Thời gian tham gia')
                    },
...

                    {
                        ...
                        formatter: function (value, row, index) {
                            return value == 1 ? adminMessage('authorBlocked', 'Đã khóa') : adminMessage('normal', 'Hoạt động');
                        }
                    },
...
function edit(id,status) {
    $.ajax({
        ...
        data: {'id':id,'status':status},// ID biểu mẫu
        async: false,
