        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    {
                        field: 'validityTime',
                        title: adminMessage('authorCodeValidUntil', 'Thời hạn hiệu lực')
                    },


                    {
                        field: 'isUse',
                        title: adminMessage('authorCodeUsed', 'Đã sử dụng'),
                        formatter: function (value, row, index) {
                            return value == 1 ? adminMessage('authorCodeUsedYes', 'Đã sử dụng') : adminMessage('authorCodeUsedNo', 'Chưa sử dụng');
                        }
                    },
                  ...
                  /*  {
                        field: 'createUserId',
                        title: adminMessage('createdById', 'ID người tạo')
                    },*/
