...
function validateRule() {
    ...
    messages: {
                                                        catId: {
                required: icon + adminMessage('newsCategoryIdRequired', 'Vui lòng chọn danh mục')
            },                                                 catName: {
                required: icon + adminMessage('newsCategoryNameRequired', 'Vui lòng nhập tên danh mục')
            },                                                                     title: {
                required: icon + adminMessage('newsTitleRequired', 'Vui lòng nhập tiêu đề')
            },                                                 content: {
                required: icon + adminMessage('newsContentRequired', 'Vui lòng nhập nội dung')
            },                                                                                                         }
})
}
